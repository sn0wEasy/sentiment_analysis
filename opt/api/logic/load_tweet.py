...
class LoadTweet:
    def load_tweet(self, word, begin_date, end_date):
        ...
        if target_dir.is_dir():
            ...
            for file in files:
                ...
                if begin_date <= csr_date and csr_date <= end_date:
                    begin_time = csr_date + 'T00:00:00Z'
                    end_time = csr_date + 'T23:59:59Z'
                    csr_fpath = f"/workspace/opt/tweets/{search_word_replaced}/{begin_time}_{end_time}.json"
